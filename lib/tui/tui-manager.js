...
class TUIManager {
  ...
  setupLayout() {
    ...
    this.footer = blessed.box({
      ...
      width: '100%',
      height: 3,
      content: 'Commands: n:New  s:Stop  l:Logs  c:Cleanup  q:Quit',
      tags: true,
      border: {
        type: 'line'
      },
  ...
  updateFooter() {
    const footerContent = {
      sessionList: 'Commands: n:New  s:Stop  l:Logs  c:Cleanup  o:Kill Orphans  q:Quit',
      sessionDetail: 'Commands: ESC:Back  s:Stop  l:Logs  q:Quit',
      logs: 'Commands: ESC:Back  q:Quit'
    };
