 ...
 *
 * MODERNIZED: Now using lodash and change-case for battle-tested implementations
...
class StringUtils {
  ...
  static capitalize(str) {
    ...
    return str; // Return unchanged if already capitalized or all uppercase
  }
  ...
  static slugify(str) {
    ...
    return changeCase.kebabCase(str.replace(/[^\w\s-]/g, ''));
  }
  ...
  static pad(str, length, padChar = ' ', direction = 'left') {
    ...
    case 'both':
      // lodash doesn't have padBoth, so we implement it
