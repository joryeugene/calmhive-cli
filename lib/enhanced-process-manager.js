/**
 * Enhanced ProcessManager with improved error handling
 * 
 * Fixes critical anti-patterns identified in analysis:
 * - Silent error swallowing in process operations
 * - Missing timeout protection 
 * - Generic error messages without context
 * - Race conditions in session status checking
 */
...
class EnhancedProcessManager {
  constructor(options = {}) {
    ...
    this.sessionLocks = new Map(); // Prevent race conditions
